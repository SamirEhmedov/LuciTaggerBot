...
@client.on(events.NewMessage(pattern="^/start$"))
async def start(event):
  await event.reply("**�LionTagBot**\n ile Grubunuzdakı Nerdeyse Tüm Üyelere Etiket Ata bilirim \nKomutlar için =======> /help yazın**",
                    buttons=(
                   
		      [Button.url('Beni Gruba Ekle ➕', https://t.me/Sohbet0_qurup)],
                      [Button.url('Support🛠', https://t.me/Sohbet0_qurup)],
                      [Button.url('Resmi Kanal📣', https://t.me/Sohbet0_qurup)],
		      [Button.url('Developer👨🏻‍💻', @SalamAlekum_buyr)],
                    ),
                    link_preview=False
                   )
@client.on(events.NewMessage(pattern="^/help$"))
async def help(event):
  helptext = "**�LionTagBot Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
  await event.reply(helptext,
                    buttons=(
                      [Button.url('Beni Gruba Ekle➕', https://t.me/Sohbet0_qurup)],
                      [Button.url('Support👨‍💻', https://t.me/Sohbet0_qurup)],
...
@client.on(events.NewMessage(pattern='^(?i)/caimport random, os, logging, asyncio
from telethon import Button
from telethon import TelegramClient, events
from telethon.sessions import StringSession
from telethon.tl.types import ChannelParticipantsAdmins
...
async def help(event):
  helptext = "*LionTagBot Komutları**\n\n**/tag <sebeb> - 5-li Etiket Atar**\n\n**/etag <sebeb> - Emoji ile etiketler**\n\n**/tektag sebeb - Üyeleri Tek Tek Etiketler**\n\n**/admins sebeb - Yöneticileri Tek Tek Tag Eder**\n\n**/start - botu başlatır**"
  await event.reply(helptext,https://t.me/Sohbet0_quruphttps://t.me/Sohbet0_qurup
                    buttons=(
                      [Button.url('Beni Gruba Ekle➕', @SalamAlekum_buyr')],
                      [Button.url('Support👨‍💻', 'https://t.me/Sohbet0_qurup')],
                      [Button.url('Resmi Kanal🔖', https://t.me/Sohbet0_qurup'')],
		      [Button.url('Developer🧑‍🔧', '@SalamAlekum_buyr')],
                    ),
